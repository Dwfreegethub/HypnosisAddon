...
### 14. Spoken orgasm denial (v0.83.1) — **open, never run live**

Two clients, the subject with *Arousal & Orgasm* ticked and BC arousal not set to Inactive. Numbered
14 because the loader's run sheet (PR #26) takes 13.
