...
const suites = ["voicetest", "speech", "sup", "part", "wake", "triggers", "scope", "arousal", "carry", "notify", "presence", "relation", "rp", "undress", "ooc", "revoke", "recovery", "illusion", "depth", "odds", "attempts", "awareness", "skill"];
let failed = false;
